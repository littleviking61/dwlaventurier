...
function render_map( $el ) {
  ...
  poly.setMap(map);
	...
	$markers.each(function(index){
			if(index === 0 || index === $markers.length-1) add_marker( $(this), map, true);
...
function add_marker( $marker, map, asMarker) {
	...
	if(asMarker) {
		// console.log('oui');
		// create marker
		var image = "/wp-content/themes/dwlaventurier/assets/img/marker.png";
